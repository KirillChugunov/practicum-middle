...
export default class ContactList extends Block {
    constructor() {
        super("section", {
            ...
            ChatCards: contactListMock.map((card) => new ChatCard({
    ...
    public render(): string {
        return `
             <a class="contact-list__profile-link"><small>Профиль ></small></a>
                 <form>
                     <input class="contact-list__search-input" placeholder="Поиск" type="search">
                   </form>
